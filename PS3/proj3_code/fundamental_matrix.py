...
def signed_point_line_errors(x_0s: list,
    ...
    for i in range(len(x_0s)):
        ...
        distance1 = point_line_distance(line1, x_0s[i])
        errors.append(distance1)

        line2 = np.dot(F.T, x_0s[i])
        distance2 = point_line_distance(line2, x_1s[i])
        errors.append(distance2)
    ##############################
